...
//            return ;
//        }
        if(this.index == 3 && this.wrap.className == 'wrap' && e.touches[0].pageY - this._touchstartY!=0){
            return;
        }


//        if(e.touches[0].pageX - this._touchstartX>0 && this._current.className.indexOf('pageR_0') != -1 && this.num ==1){
//            this.right = 1;
//        }else{
//            this.right = 2
//            ;
...
//        switch(this.right){
//            case 1 :
//                if(e.touches[0].pageX - this._touchstartX>0 && this._current.className.indexOf('pageR_0') != -1&& this.left== false){
//                    this.left=!this.left;
//                    this.num=1;
//                }
//                break;
...
//
//        if(this.num ==1){
//            if(e.touches[0].pageX - this._touchstartX<0 && this._current.className.indexOf('pageR_0') != -1){
//                return
//            }
//        }else if(this.num ==2){
//            if(e.touches[0].pageX - this._touchstartX>0 && this._current.className.indexOf('pageR_0') != -1){
