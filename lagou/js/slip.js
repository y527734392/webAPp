  ...
  Slip = (function() {
    ...
    Slip.prototype.onTouchMove = function(event) {
	  ...
	  var oPage5Form = document.getElementById('page5_form'),
	  	  oPage5Form2 = document.getElementById('page5_form2'),
		  opage6 = document.getElementById('page6');
	  if(this.page == 4){
		  if(oPage5Form.style.display != 'none' || oPage5Form2.style.display != 'none' || opage6.style.display != 'none'){
				this._isPressed = false;
			}else{
				this._isPressed = true;
			}
	...
	Slip.prototype.pageLoop = function(){
		if (this.direction === X) {
